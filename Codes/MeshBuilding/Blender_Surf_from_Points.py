...
2012/11/06 v0.17, t26
  + updated to work on Blender 2.64 in which mesh and face system 
    has been changed drastically.
  + changed simply "mesh.faces" to "mesh.tessfaces".
    (This information was provided kindly from BuildingTheWorld 
    in YouTube, special thanks.)
...
2012/01/07 v0.15, t24
  ...
  + the detail change points are:
    ...
    + use new Vector, Matrix, .cross, .normalized, and .angle in 
      mathutils module.
